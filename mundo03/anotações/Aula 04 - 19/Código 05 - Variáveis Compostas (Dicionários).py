...
estado1 = {
    "uf": "Rio de Janeiro",
    "sigla": "RJ",
}  # Cria um dicionário "estado1" com 2 chaves e 2 valores
estado2 = {
    "uf": "São Paulo",
    "sigla": "SP",
}  # Cria um dicionário "estado2" com 2 chaves e 2 valores
brasil.append(
    estado1
)  # Adiciona o dicionário "estado1" inteiro ao final da lista "brasil", como índice [0]
brasil.append(
    estado2
)  # Adiciona o dicionário "estado2" inteiro ao final da lista "brasil", como índice [1]
...
print(
    brasil
)  # Exibe [{'uf': 'Rio de Janeiro', 'sigla': 'RJ'}, {'uf': 'São Paulo', 'sigla': 'SP'}]
